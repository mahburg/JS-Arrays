...
// Your job is to write a function named finder that will get a random number (by invoking getRandomArbitrary), then loop through the array (that will be passed in as a parameter) to see if that random number is in the array. If it is, return true, if it's not, return false
  ...
  function finder(numbers){
    ...
    return numbers.indexOf(rn) !== -1 ? false : true;
  }
...
*/
  ...
  function removeItem(myGroceryList, item) {
    ...
    var itemInd = myGroceryList.indexOf(item);
    if (myGroceryList.indexOf(item) !== -1){
      myGroceryList.splice(itemInd, 1);
    }
...
var user2 = {
    name: 'Data Soogn',
    email: 'positronic@gmail.com',
    password: '$p0t',
    username: 'SecondOfficer'
};
var user3 = {
    name: 'Jon Dough',
    email: 'jd@gmail.com',
    password: 'cantremember',
    username: 'remembernot'
};
users.push(user1);
users.push(user2);
users.push(user3);
